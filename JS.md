...
- `{ }`: is mainly used for `Dictionaries/Object creation`
- `( )`: is mainly used for `Passing arguments for functions`
...
```js
array.push(20); // adds a new element
